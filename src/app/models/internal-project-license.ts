...
export class InternalProjectLicense extends LicenseApprovalModel<InternalProjectLicenseService, InternalProjectLicense> {
  ...
  getProjectSummaryFields(control: boolean = false): any {
    ...
    return {
      ...
      expectedImpact: control ? [expectedImpact, [CustomValidators.required]] : expectedImpact,
      sustainabilityItems: control ? [sustainabilityItems, [CustomValidators.required]] : sustainabilityItems,
    }
  }
