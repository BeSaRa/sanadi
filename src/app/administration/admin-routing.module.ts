...
const routes: Routes = [
  ...
  {
    path: 'risk-level', component: RiskLevelComponent,
    canActivate: [PermissionGuard.canActivate],
    data: { permissionKey: PermissionsEnum.MANAGE_RISK_LEVEL, configPermissionGroup: null, checkAnyPermission: false }
  },
  {
    path: 'risk-level-determination', component: RiskLevelDeterminationComponent,
    canActivate: [PermissionGuard.canActivate],
    data: {
