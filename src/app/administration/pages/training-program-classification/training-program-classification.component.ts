import { TrainingProgramClassificationService } from './../../../services/training-program-classification.service';
...
@Component({
  selector: 'training-program-classification',
  templateUrl: './training-program-classification.component.html',
  styleUrls: ['./training-program-classification.component.scss']
})
export class TrainingProgramClassificationComponent extends AdminGenericComponent<TrainingProgramClassification, TrainingProgramClassificationService> {
  afterReload(): void {
  ...
  constructor(public lang: LangService,
    public service: TrainingProgramClassificationService,
  ...
  view$: Subject<TrainingProgramClassification> = new Subject<TrainingProgramClassification>();

  actions: IMenuItem<TrainingProgramClassification>[] = [
    // edit
    {
      type: 'action',
      label: 'btn_edit',
      icon: ActionIconsEnum.EDIT,
      onClick: (item: TrainingProgramClassification) => this.edit$.next(item)
    },
    // delete
    {
      type: 'action',
      ...
      onClick: (item: TrainingProgramClassification) => this.delete(item)
    },
    // view
    {
      type: 'action',
      ...
      onClick: (item: TrainingProgramClassification) => this.view$.next(item)
    },
    // activate
    {
      type: 'action',
      ...
      label: 'btn_activate',
      onClick: (item: TrainingProgramClassification) => this.toggleStatus(item),
      displayInGrid: false,
      show: (item) => {
      ...
      children: [
        {
          ...
          show: (_items: TrainingProgramClassification[]) => {
            return true;
          }
        },
        {
  ...
  sortingCallbacks = {
    statusInfo: (a: TrainingProgramClassification, b: TrainingProgramClassification, dir: SortEvent): number => {
  ...
  get selectedRecords(): TrainingProgramClassification[] {
  ...
  delete(model: TrainingProgramClassification, event?: MouseEvent): void {
  ...
  toggleStatus(model: TrainingProgramClassification) {
