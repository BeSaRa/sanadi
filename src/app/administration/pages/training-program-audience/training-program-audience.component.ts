...
@Component({
  selector: 'training-program-audience',
  templateUrl: './training-program-audience.component.html',
  styleUrls: ['./training-program-audience.component.scss']
})
export class TrainingProgramAudienceComponent extends AdminGenericComponent<TrainingProgramAudience, TrainingProgramAudienceService> {
  afterReload(): void {
  ...
  constructor(public lang: LangService,
    public service: TrainingProgramAudienceService,
  ...
  view$: Subject<TrainingProgramAudience> = new Subject<TrainingProgramAudience>();

  actions: IMenuItem<TrainingProgramAudience>[] = [
    // edit
    {
      type: 'action',
      label: 'btn_edit',
      icon: ActionIconsEnum.EDIT,
      onClick: (item: TrainingProgramAudience) => this.edit$.next(item)
    },
    // delete
    {
      type: 'action',
      ...
      onClick: (item: TrainingProgramAudience) => this.delete(item)
    },
    // view
    {
      type: 'action',
      ...
      onClick: (item: TrainingProgramAudience) => this.view$.next(item)
    },
    // activate
    {
      type: 'action',
      ...
      label: 'btn_activate',
      onClick: (item: TrainingProgramAudience) => this.toggleStatus(item),
      displayInGrid: false,
      show: (item) => {
      ...
      children: [
        {
          ...
          show: (_items: TrainingProgramAudience[]) => {
            return true;
          }
        },
        {
  ...
  sortingCallbacks = {
    statusInfo: (a: TrainingProgramAudience, b: TrainingProgramAudience, dir: SortEvent): number => {
  ...
  get selectedRecords(): TrainingProgramAudience[] {
  ...
  delete(model: TrainingProgramAudience, event?: MouseEvent): void {
  ...
  toggleStatus(model: TrainingProgramAudience) {
