...
export class OrganizationUserPopupComponent implements OnInit {
  ...
  buildForm(): void {
    this.form = this.fb.group({
      ...
      qid: [this.model.qid, [Validators.required, CustomValidators.number, Validators.minLength(7), Validators.maxLength(10)]],
      empNum: [this.model.empNum, [Validators.required, CustomValidators.number, Validators.maxLength(10)]],
      phoneNumber: [this.model.phoneNumber, [Validators.required, CustomValidators.number, Validators.maxLength(CustomValidators.defaultLengths.PHONE_NUMBER_MAX)]],
