...
export class SendToMultipleComponent implements OnInit, OnDestroy {
  ...
  multiSendToDepartmentWFResponseList = [
    ...
    WFResponseType.FINAL_EXTERNAL_OFFICE_SEND_TO_MULTI_DEPARTMENTS,
    WFResponseType.PARTNER_APPROVAL_SEND_TO_MULTI_DEPARTMENTS,
    ...
    WFResponseType.FINANCIAL_ANALYSIS_SEND_TO_MULTI_DEPARTMENT,
