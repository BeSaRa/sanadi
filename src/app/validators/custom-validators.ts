...
const commonValidations = {
  ...
  swiftCode: [maxLength(defaultLengths.SWIFT_CODE_MAX), minLength(defaultLengths.SWIFT_CODE_MIN), pattern('ENG_NUM_ONLY')],
  email: [ pattern('EMAIL'), maxLength(defaultLengths.EMAIL_MAX)],
