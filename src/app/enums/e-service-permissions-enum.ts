export enum EServicePermissionsEnum {
  ...
  SEARCH_SERVICE_URGENT_INTERVENTION_LICENSING = 'SEARCH_SERVICE_URGENT_INTERVENTION_LICENSING',
  URGENT_INTERVENTION_ANNOUNCEMENT = 'URGENT_INTERVENTION_ANNOUNCEMENT',
  SEARCH_SERVICE_URGENT_INTERVENTION_ANNOUNCEMENT = 'SEARCH_SERVICE_URGENT_INTERVENTION_ANNOUNCEMENT',
  ...
  SEARCH_SERVICE_FUNDRAISING_LICENSING = 'SEARCH_SERVICE_FUNDRAISING_LICENSING',
  ...
  SEARCH_SERVICE_URGENT_INTERVENTION_CLOSURE = 'SEARCH_SERVICE_URGENT_INTERVENTION_CLOSURE',
  URGENT_INTERVENTION_FINANCIAL_NOTIFICATION = 'URGENT_INTERVENTION_FINANCIAL_NOTIFICATION',
  SEARCH_SERVICE_URGENT_INTERVENTION_FINANCIAL_NOTIFICATION = 'SEARCH_SERVICE_URGENT_INTERVENTION_FINANCIAL_NOTIFICATION',
  URGENT_INTERVENTION_LICENSE_FOLLOWUP = 'URGENT_INTERVENTION_LICENSE_FOLLOWUP',
  SEARCH_SERVICE_URGENT_INTERVENTION_LICENSE_FOLLOWUP = 'SEARCH_SERVICE_URGENT_INTERVENTION_LICENSE_FOLLOWUP',
  ...
  SEARCH_SERVICE_PROJECT_COMPLETION = 'SEARCH_SERVICE_PROJECT_COMPLETION',
  FINANCIAL_ANALYSIS = 'FINANCIAL_ANALYSIS',
  SEARCH_SERVICE_FINANCIAL_ANALYSIS = 'SEARCH_SERVICE_FINANCIAL_ANALYSIS',
  INSPECTION = 'INSPECTION',
  SEARCH_SERVICE_INSPECTION = 'SEARCH_SERVICE_INSPECTION',
  PROPOSED_INSPECTION = 'PROPOSED_INSPECTION',
  ACTUAL_INSPECTION = 'ACTUAL_INSPECTION',
  PENALTIES_AND_VIOLATIONS = 'PENALTIES_AND_VIOLATIONS',
  SEARCH_SERVICE_PENALTIES_AND_VIOLATIONS ='SEARCH_SERVICE_PENALTIES_AND_VIOLATIONS',
  MANAGE_PENALTIES_VIOLATIONS_LOGS = 'MANAGE_PENALITES_VIOLATIONS_LOGS',
