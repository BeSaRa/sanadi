...
export class UserHomeComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.serviceList = [
      ...
      new ServiceItem(2, this.langService.getArabicLocalByKey('menu_inquiries'), this.langService.getEnglishLocalByKey('menu_inquiries'), './inquiry', 'mdi-account-search'),
      new ServiceItem(5, this.langService.getArabicLocalByKey('menu_request_search'), this.langService.getEnglishLocalByKey('menu_request_search'), './request-search', 'mdi-text-box-search-outline'),
