...
} from '@modules/services/customs-exemption-remittance/pages/customs-exemption-outputs/customs-exemption-outputs.component';
...
const routes: Routes = [
  ...
  {
    path: 'outputs', component: CustomsExemptionOutputsComponent,
    canActivate: [NewServicePermissionGuard.canActivate],
    data: {
...
export class CustomsExemptionRemittanceRoutingModule { }
