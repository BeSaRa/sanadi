...
} from '@modules/services/organization-entities-support/pages/organization-entities-support-outputs/organization-entities-support-outputs.component';
...
export class OrganizationEntitiesSupportRoutingModule { }
