...
} from '@modules/services/partner-approval/pages/partner-approval-outputs/partner-approval-outputs.component';
...
const routes: Routes = [
  ...
  {
    path: 'outputs', component: PartnerApprovalOutputsComponent,
    canActivate: [NewServicePermissionGuard.canActivate],
    data: {
...
export class PartnerApprovalRoutingModule { }
