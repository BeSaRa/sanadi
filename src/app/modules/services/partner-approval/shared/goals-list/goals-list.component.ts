...
export class GoalsListComponent extends UiCrudListGenericComponent<GoalList> {
  ...
  sortingCallbacks = {
    ...
    dac: (a: GoalList, b: GoalList, dir: SortEvent): number => {
      let value1 = !CommonUtils.isValidValue(a) ? '' : a.mainDACCategoryInfo.getName().toLowerCase(),
        value2 = !CommonUtils.isValidValue(b) ? '' : b.mainDACCategoryInfo.getName().toLowerCase();
      return CommonUtils.getSortValue(value1, value2, dir.direction);
    },
