...
} from '@app/modules/services/urgent-intervention-closure/popups/implementation-evaluation-popup/implementation-evaluation-popup.component';
...
export class ImplementationEvaluationListComponent extends UiCrudListGenericComponent<OfficeEvaluation> {
  ...
  _getDeleteConfirmMessage(record: OfficeEvaluation): string {
    return this.lang.map.msg_confirm_delete_x.change({x: record.evaluationHubInfo.getName()})
  }
