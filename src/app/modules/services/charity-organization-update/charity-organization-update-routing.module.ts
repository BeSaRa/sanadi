...
} from '@modules/services/charity-organization-update/pages/charity-organization-update-outputs/charity-organization-update-outputs.component';
...
const routes: Routes = [
  ...
  {
    path: 'outputs', component: CharityOrganizationUpdateOutputsComponent,
    canActivate: [NewServicePermissionGuard.canActivate],
    data: {
...
export class CharityOrganizationUpdateRoutingModule { }
