...
} from '@modules/services/fundraising-channel-licensing/pages/fundraising-channel-licensing-outputs/fundraising-channel-licensing-outputs.component';
...
const routes: Routes = [
  ...
  {
    path: 'outputs', component: FundraisingChannelLicensingOutputsComponent,
    canActivate: [NewServicePermissionGuard.canActivate],
    data: {
...
export class FundraisingChannelLicensingRoutingModule { }
