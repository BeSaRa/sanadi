...
} from '@modules/services/transferring-individual-funds-abroad/pages/transferring-individual-funds-abroad-outputs/transferring-individual-funds-abroad-outputs.component';
...
const routes: Routes = [
  ...
  {
    path: 'outputs', component: TransferringIndividualFundsAbroadOutputsComponent,
    canActivate: [NewServicePermissionGuard],
    data: {
...
export class TransferringIndividualFundsAbroadRoutingModule { }
