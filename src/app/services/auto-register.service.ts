...
import { FinancialAnalysisComponent } from '@app/modules/services/financial-analysis/pages/financial-analysis/financial-analysis.component';
import { PenaltiesAndViolationsComponent } from '@app/modules/services/penalties-and-violations/pages/penalties-and-violations/penalties-and-violations.component';
...
export class AutoRegisterService {
  ...
  private ngOnInit(): void {
    new DynamicComponentService(() => {
      ...
      DynamicComponentService.registerComponent('FinancialAnalysisComponent', FinancialAnalysisComponent);
      DynamicComponentService.registerComponent('PenaltiesAndViolationsComponent', PenaltiesAndViolationsComponent);
