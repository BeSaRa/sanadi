...
import { TransferringIndividualFundsAbroadComponent } from './../projects/pages/transferring-individual-funds-abroad/transferring-individual-funds-abroad.component';
@Injectable({
  providedIn: 'root'
})
