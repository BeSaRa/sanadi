...
import {catchError, filter, map, share, switchMap, takeUntil} from 'rxjs/operators';
...
export class NotificationService implements OnDestroy {
    ...
    displayDesktopNotification(title: string, body: string): void {
        of(true)
            .pipe(
                filter(() => ('Notification' in window && !!Notification)),
                switchMap(() => {
